...
console.log("\ntimeline");
{
  ...
  // Stated as an assertion because a dissolve is what anyone assembling this would reach
  // for, and the user ruled it out: every join is a straight cut.
  eq(t.transition, { kind: "cut", frames: 0 }, "every join is a cut — no dissolve of any length");
  // Two rendered segments of 900 and 900 frames, cut at 900 and 822. Nothing overlaps.
  eq(t.durationInFrames, 900 + 822, "a cut overlaps nothing, so the section is the sum of its trimmed segments");
